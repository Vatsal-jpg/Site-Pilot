    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.success && res.token) {
                ...
                // Also set a document cookie so Next.js middleware can read it
        ...
        <div className="min-h-screen bg-[#0d0d12] flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-[#1a1a24] rounded-2xl p-8 border border-white/10 shadow-xl">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight text-white mb-2">Welcome back to SitePilot</h1>
