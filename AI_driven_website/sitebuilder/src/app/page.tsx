      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        >
          ...
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-sm text-indigo-300 mb-6 tracking-wide">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-indigo-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-indigo-500"></span>
              </span>
              SitePilot V2 is live
            </div>
          ...
          <div className="relative mt-8 lg:mt-0 aspect-square lg:aspect-auto">
            ...
            <div className="relative z-20 bg-[#1a1a24] border border-white/10 rounded-2xl shadow-2xl p-2 w-full max-w-lg mx-auto lg:ml-auto transform transition-transform hover:-translate-y-2 duration-500">
              <div className="flex items-center gap-1.5 px-3 py-2 mb-2 border-b border-white/5">
              ...
              <img
                ...
                className="rounded-lg object-cover w-full h-auto opacity-90"
              />
            </div>

            {/* Floating accent elements */}
            <div className="float absolute -top-8 -left-8 lg:-left-12 z-30 bg-[#1a1a24] p-4 rounded-xl border border-white/10 shadow-xl flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-indigo-500/20 flex items-center justify-center">
                <Zap className="h-5 w-5 text-indigo-400" />
              </div>
              <div>
                <div className="text-sm font-bold text-white">AI Generated</div>
                <div className="text-xs text-gray-400">in 12 seconds</div>
              </div>
            </div>

            <div className="float absolute -bottom-8 -right-8 lg:-right-12 z-30 bg-[#1a1a24] p-4 rounded-xl border border-white/10 shadow-xl flex items-center gap-4 hidden sm:flex" style={{ animationDelay: "2s" }}>
              <div className="w-10 h-10 rounded-full bg-emerald-500/20 flex items-center justify-center">
                <Globe className="h-5 w-5 text-emerald-400" />
              </div>
              <div>
                <div className="text-sm font-bold text-white">Deployed Live</div>
                <div className="text-xs text-green-400">mysite.com</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-white/10 py-12 mt-12">
        <div className="mx-auto max-w-7xl px-4 flex flex-col md:flex-row items-center justify-between gap-6 pb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight text-white/90">SitePilot</span>
          </div>
